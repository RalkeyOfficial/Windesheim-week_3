    ...
    <main>
        ...
        <h1 class="highlights">Highlighted products!</h1>
            <div class="row">
                <div>
                    <h3>Product name</h3>
                    <a href=""><img src="img/highlighted-products/Ryzen-7-7800X3D.jpg" alt="highlighted product" class="boxes"><button class="pricetag">€500</button></a>
                </div>
                <div>
                    <h3>Product name</h3>
                <a href=""><img src="img/highlighted-products/Asus-ROG-STRIX-B650E-F-GAMING-WIFI.jpg" alt="highlighted product" class="boxes"><button class="pricetag">€400</button></a>
                </div>
                <div>
                    <h3>Product name</h3>
                <a href=""><img src="img/highlighted-products/Corsair-DDR4-Vengeance.jpg" alt="highlighted product" class="boxes"><button class="pricetag">€200</button></a>
                </div>
                <div>
                    <h3>Product name</h3>
                <a href=""><img src="img/highlighted-products/Fractal-Design-North-Charcoal-Black-TG-Dark.jpg" alt="highlighted product" class="boxes"><button class="pricetag">€150</button></a>
                </div>
                <div>
                    <h3>Product name</h3>
                <a href=""><img src="img/highlighted-products/MSI-G272QPF.jpg" alt="highlighted product" class="boxes"><button class="pricetag">€500</button></a>
                </div>
            </div>
        </div>
